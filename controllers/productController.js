...
exports.addProduct = BigPromise(async (req, res, next) => {
    ...
    req.body.user = req.user.id; //coming from middleware isLoggedIn
...
exports.getSingleProductDetails = BigPromise(async (req, res, next) => {
...
exports.addReview = BigPromise(async (req, res, next) => {
    ...
    const alreadyReviewed = await product.reviews.find(
        (rev) => rev.user.toString() === req.user._id.toString()  //BSON value changed to string
    )
